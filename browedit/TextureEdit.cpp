...
void BrowEdit::textureEditUpdate()
{
	...
	if (mouseState.leftButton && ( !lastMouseState.leftButton || mouseState.position != lastMouseState.position ) && !wm->inWindow(mouseState.position) && textureWindow->selectedImage != -1)
	{
